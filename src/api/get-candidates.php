...
if(!empty($key)) {
	...
	$query = "
		SELECT
			b.id, b.key, b.name, b.positions, b.register, b.resultsRelease, b.voteCutoff, b.hideNames, b.hideDetails, b.allowCustom, b.showGraph, b.kickbackUrl, b.iframeUrl, e.entry_id, e.image, e.hyperlink, e.color, e.name AS 'candidate'
		FROM
			entries e
		JOIN
			ballots b
